...
class DesktopSQLTool:
    ...
    def create_query_panel(self, parent):
        ...
        self.line_numbers = tk.Text(query_text_frame, width=4, bg='#f0f0f0', fg='#888888', 
        ...
        self.query_text.tag_configure('comment', foreground='gray', font=('Consolas', 11, 'italic'))
    ...
    def create_status_bar(self, parent):
        ...
        self.query_status = ttk.Label(status_frame, text="Ready")
    ...
    def show_cell_value(self, event):
        ...
        # Show full value in a popup
        popup = tk.Toplevel(self.root)
        popup.title("Cell Value")
        popup.geometry("400x300")
        
        text = scrolledtext.ScrolledText(popup, wrap='word')
